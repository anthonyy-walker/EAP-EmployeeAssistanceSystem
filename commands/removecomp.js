        ...
        const guild = client.guilds.cache.get('507924040636432388')
            ...
            if(mentioned) {
                ...
                const CustomsHostd = new Discord.MessageEmbed()
                    ...
                    .setDescription( `**Competitive Role** role was removed from ${mentioned} :outbox_tray:` )
                    .setColor("#990000");
                ...
                await getChannel.send(`<@${executor.id}> removed the Competitive role from <@${mentioned.id}>`);
