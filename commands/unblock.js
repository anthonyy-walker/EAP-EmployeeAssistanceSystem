...
module.exports = {
    ...
    execute: async function (client, message, args){
        ...
        const guild = client.guilds.cache.get('507924040636432388')
            const role = guild.roles.cache.find(role => role.name === 'blocked');
            ...
            if(mentioned) {
                ...
                const CustomsHostd = new Discord.MessageEmbed()
                    ...
                    .setDescription( `**blocked** role was removed from ${mentioned} :outbox_tray:` )
                    .setColor("#990000");
                ...
                await getChannel.send(`<@${executor.id}> removed the blocked role from <@${mentioned.id}>`);
