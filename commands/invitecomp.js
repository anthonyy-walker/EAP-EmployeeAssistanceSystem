...
module.exports = {
    ...
    execute: async function (client, message, args, reaction, user, ) {
        ...
        if (!executor.roles.cache.has('746891802128416847') && (!executor.roles.cache.has('645094960563224603') && (!executor.roles.cache.has('737310702951333899') && (!executor.roles.cache.has('737310698870407208') && (!executor.roles.cache.has('700570574988116010')))))) {
            return message.reply('Nope')
        } else {
            const compguild = client.guilds.cache.get('746891173247057991')
            const channell = await compguild.channels.cache.get('746891173695848529');
