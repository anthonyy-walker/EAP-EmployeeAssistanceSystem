        ...
        const guild = client.guilds.cache.get('507924040636432388')
            ...
            if(mentioned) {
                ...
                const CustomsHostd = new Discord.MessageEmbed()
                    ...
                    .setDescription( `**Customs Host** role was added to ${mentioned} :inbox_tray:` )
                    .setColor("#990000");
                await message.channel.send(CustomsHostd);
                const cooldowns = new Discord.Collection();
                const getChannel = await getGuild.channels.cache.get('737310765694058590');
                await getChannel.send(`<@${executor.id}> gave <@${mentioned.id}> the Customs Host role!`);
                const newhost = new Discord.MessageEmbed()
                .setAuthor(`Welcome`)
                .setDescription( `Welcome ${mentioned} please look at <#737310759482032149> and <#737310761550086154> When hosting games please use <#737310757082890271> If you have any further questions type **!requesthelp** in <#737338320455204874>.` )
                .setColor("#990000");
